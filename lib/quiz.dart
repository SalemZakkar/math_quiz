        ...
        child:new Column(
          ...
          children: [
            ...
            AnimatedSwitcher(duration: Duration(milliseconds: 700)
              ,child: question(height, width , questions[index].quest,questions[index].req,  UniqueKey()),
                ...
                child: new Column(
                  ...
                  children: [
                    new Container(
                      ...
                      child: new Row(
                        ...
                        children: [
                          ...
                          SizedBox(height: height*0.1,width:width*0.48,
                            child: new RaisedButton(
                            onPressed: ()async {
                            if(questions[index].answers[0] == questions[index].correct){
                            ...
                            await player.play();
                              ...
                              child:  DefaultTextStyle(
                                  ...
                                  child: CaTeX(questions[index].answers[0]))),),
                          Expanded(child: SizedBox()),
                          // ignore: deprecated_member_use
                          SizedBox(height: height*0.1,width:width*0.48,child: new RaisedButton(onPressed: ()async {
                            if(questions[index].answers[1] == questions[index].correct){
                              ...
                              child: DefaultTextStyle(
                                  style: new TextStyle(color: Colors.white,fontSize: 10),
                                  child: CaTeX(questions[index].answers[1])))),
                          new SizedBox(width: width*0.01,)
                        ],
                      ),
                    ),
                    ...
                    new Container(
                      ...
                      child: new Row(
                        ...
                        children: [
                          ...
                          SizedBox(height: height*0.1,width:width*0.48,
                              child: new RaisedButton(
                            child: DefaultTextStyle(style: new TextStyle(color: Colors.white,fontSize: 10),
                                child: CaTeX(questions[index].answers[2])),onPressed: ()async{
                            if(questions[index].answers[2] == questions[index].correct){
                              setState(() {
                                b3 = green;
                                isSolved = true;
                              });
                          ...
                          SizedBox(height: height*0.1,width:width*0.48,
                              child: new RaisedButton(
                                child: DefaultTextStyle(style: new TextStyle(color: Colors.white,fontSize: 10),
                                    child: CaTeX(questions[index].answers[3])),onPressed: ()async{
                            if(questions[index].answers[3] == questions[index].correct){
                              setState(() {
                                b4 = green;
                                isSolved = true;
                              });
                    ...
                    new Container(
                      ...
                      color: Colors.white,
                      // ignore: deprecated_member_use
                      child: new RaisedButton(child: new Text("Help" , style: new TextStyle(color: Colors.white),),onPressed: (){
                        showHelp(context, questions[index].help, height, width);
                      },color: Color.fromRGBO(66,39,255,1),shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(50.0))),),
                    ),
